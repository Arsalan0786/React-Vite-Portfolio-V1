...
import { ArrowLeft, Dumbbell, Flame, HeartPulse, Trophy, Sparkles, Timer } from 'lucide-react';
...
const focusAreas = [
  {
    ...
    description: 'Progressive overload programs, mobility drills, and form coaching tailored to your body type.'
  },
  {
    title: 'Nutrition Blueprint',
    description: 'Macro-balanced meal plans, supplement guidance, and sustainable habits that match your lifestyle.'
  },
  {
    title: 'Mindset & Accountability',
    description: 'Weekly check-ins, habit tracking, and performance reviews to keep you consistent and motivated.'
  }
];
...
const phases = [
  {
    ...
    detail: 'Movement screening, breath work, nervous system reset, and daily habit stacking.',
  },
  {
    title: 'Phase 2 · Build & Sculpt',
    detail: 'Hybrid strength splits, progressive overload tracking, mobility supersets, and metabolic circuits.',
  },
  {
    title: 'Phase 3 · Peak & Sustain',
    detail: 'Performance metrics, lifestyle guardrails, nutrition cycling, and long-term accountability.',
  },
];
      ...
      <div className="max-w-5xl mx-auto px-6 py-14 space-y-12">
          ...
          <div className="flex gap-3">
            {statBlocks.map((stat) => (
              ...
              >
                ...
                <p className="text-[11px] uppercase tracking-[0.3em]">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-[1.2fr,0.8fr] gap-10 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl leading-tight font-semibold">
                Full-body transformation engineered through precision training, metabolic flow, and deep accountability.
              </h1>
              <p className={`text-lg ${theme === 'dark' ? 'text-zinc-300' : 'text-zinc-600'}`}>
                This immersive coaching container blends performance science with lifestyle design to help you move, eat,
                and think like an athlete—no matter your starting point.
              </p>
              <div className="flex flex-wrap gap-3">
                {['Custom dashboards', 'Nutrition intelligence', 'Mindset rewiring', 'Recovery rituals'].map((pill) => (
                  <span
                    key={pill}
            ...
            <div className="relative h-[320px] rounded-[30px] overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 h-full flex items-end p-6">
                ...
                >
                  <p className="text-sm uppercase tracking-[0.3em] text-zinc-300">Currently coaching</p>
                  <p className="text-2xl font-semibold">12 Active Athletes</p>
                  <p className="text-sm text-zinc-200">Next intake opens Feb 2025</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center gap-3">
              <Timer className={theme === 'dark' ? 'text-pink-300' : 'text-pink-600'} />
              <p className="text-lg font-semibold">Interactive Weekly Ritual</p>
            </div>
            <ul className={`space-y-3 text-base ${theme === 'dark' ? 'text-zinc-300' : 'text-zinc-600'}`}>
              <li>• Sunday blueprint call with macro + training adjustments.</li>
              <li>• Mid-week video form review with cues & corrections.</li>
              <li>• Live breathwork + recovery protocols for nervous system reset.</li>
            </ul>
          </div>
          <div
            className={`rounded-[32px] p-8 border ${
          ...
          >
            <h2 className="text-3xl font-semibold">Coaching that feels alive.</h2>
            <p className={theme === 'dark' ? 'text-zinc-400' : 'text-zinc-600'}>
              I design the entire cadence so you never train alone: cinematic dashboards, motion cues, nutrition audits,
              and mindset frameworks keep you anchored, focused, and inspired throughout each phase.
            </p>
            <div className="grid sm:grid-cols-3 gap-4">
              {['Form Labs', 'Nutrition Sync', 'Mindset Therapy'].map((item) => (
                <div
                  key={item}
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-zinc-500">Framework</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {focusAreas.map((area, index) => (
              ...
              >
                <p className={`text-xs uppercase tracking-[0.2em] ${theme === 'dark' ? 'text-pink-300' : 'text-pink-600'}`}>
                  Step {index + 1}
                </p>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-5 text-lg">
            <p>
              • Cinematic dashboards that visualize your strength, mobility, and recovery progress weekly.
            </p>
            <p>
              • Layered meal design with macro cycling, micro support, and lifestyle-friendly rituals.
            </p>
            <p>
              • Deep nervous system support: mobility labs, breath ladders, cold exposure primers.
            </p>
            <p>
              • Mindset recalibration through journaling frameworks and weekly pattern audits.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {phases.map((phase, idx) => (
                <div key={phase.title} className="space-y-2">
                  <p className={`text-xs uppercase tracking-wide ${theme === 'dark' ? 'text-pink-300' : 'text-pink-600'}`}>
                    Phase {idx + 1}
                  </p>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {milestones.map((item) => (
                ...
                >
                  <item.icon size={20} className={theme === 'dark' ? 'text-pink-300' : 'text-pink-600'} />
        ...
        <section className="text-center space-y-4">
          <p className={`text-lg ${theme === 'dark' ? 'text-zinc-300' : 'text-zinc-700'}`}>
            Ready to begin? Let&apos;s tailor a phase-wise plan that honors your lifestyle,
            energizes your mindset, and delivers undeniable results.
          </p>
          {/* <button
