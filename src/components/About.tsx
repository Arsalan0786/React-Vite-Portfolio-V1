            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-4 w-full max-w-xs">
                <a
                  ...
                  className={`flex items-center justify-center gap-4 px-6 py-3 rounded-lg transition-all ${
                    theme === 'dark'
                ...
                <button
                  ...
                  className={`flex items-center justify-center gap-3 px-6 py-3 rounded-lg text-sm font-semibold transition-all border ${
                    theme === 'dark'
