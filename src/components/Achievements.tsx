...
const achievements: Achievement[] = [
  ...
  },
  {
    ...
    date: 'January 2025',
    category: 'certificate',
    description: 'Advanced certification in C Programming and best practices',
    detailedDescription: 'Comprehensive professional certification focused on advanced C programming concepts, memory management, data structures, algorithms, and system-level programming. Covers pointers, dynamic allocation, file handling, process management, and optimization techniques for high-performance applications.',
    skills: ['C', 'Data Structures', 'Algorithms', 'Memory Management', 'Pointers', 'File Handling', 'System Programming'],
  },
  {
    id: 3,
